...
import {Button, Card, CardGroup, Container, Form, Image} from "react-bootstrap";
...
const UserProfile = ({ userId }) => {
    ...
    const verifyPwdChange = async () => {
        console.log("validate pwd change : ", userPwdChange);
        ...
        if (flag === false) {
            await doPasswordChange(userPwdChange.newPwd).then((pwd) => {
                console.log("PASSORD WAS CHANGED CORRECTLY. ", pwd);
