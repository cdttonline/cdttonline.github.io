...
import {doSignInWithEmailAndPassword, doSignOut, getUserAuthentication} from "../firebase/auth";
...
const NavBar = ( { isLoggedIn, setIsLoggedIn, user }) => {
    ...
    useEffect(() => {
        console.log("Navigate a changee")
        // Example: Redirecting to another route after rendering
        // if (localStorage.getItem('isUserNotDoneRegistering') === 'false') {
        //     navigate('/'); // Replace '/anotherRoute' with your actual route
    ...
    const navigateToData = () => { navigate("/testData"); }
    const navigateToMyProfile = () => { navigate("/myProfile"); }
    const navigateToUsers = () => { navigate("/usersData"); }
    const navigateToInternalCalibration = () => { navigate("/internalCalibration"); }
                ...
                <Container id="navbarContainer">
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" col>
                        ...
                        >
                            ...
                            >Research Platform</Nav.Link>
                            <Nav.Link id="barForNav" className={"px-1"} disabled={true}>|</Nav.Link>

                            <Nav.Link 
                                eventKey={3}
                                onClick={navigateToTest}
                            >Online Testing</Nav.Link>
                            <Nav.Link id="barForNav" className={"px-1"}  disabled={true}>|</Nav.Link>
                            ...
                            {(isLoggedIn && (user.type === 'Admin')) ? (
                                <>
                                    ...
                                    <NavDropdown title="Data" id="basic-nav-dropdown">
                                        <NavDropdown.Item onClick={navigateToData}>Test Results</NavDropdown.Item>
                                        <NavDropdown.Item onClick={navigateToInternalCalibration}>
                                            Internal Calibration
                                        </NavDropdown.Item>
                                    </NavDropdown>
                                    <Nav.Link id="barForNav" className={"px-1"}  disabled={true}>|</Nav.Link>

                                    <Nav.Link eventKey={6} onClick={navigateToUsers}>Users</Nav.Link>
                                </>
                                ) : <></>
                            }
                                ...
                                <>
                                    ...
                                    <div className="secondNavBar secondFlexNavBar">
                                        ...
                                        <div className={"d-flex"}>
                                            <Nav.Link eventKey={7} id="navBarLanguage">FR</Nav.Link>
                                            <Nav.Link eventKey={8} id="separatorNavBar" className={"px-1"}
                                                      disabled>|</Nav.Link>
                                            ...
                                            <Nav.Link eventKey={9} onClick={navigateToMyProfile}>
                                        ...
                                        <div className="logoutNavBar">
                                            <Nav.Link eventKey={10} onClick={handleLogout}>Logout</Nav.Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="secondDropDownNavBar">
                                        ...
                                        <NavDropdown title={
                                            ...
                                            <NavDropdown.Item href="#action/3.1" disabled={true} className={"m-0 py-0"}>
                                                <div className="my-0 py-1" style={{
                                                    fontSize: '1.0rem',
                                                    color: 'GrayText'
                                                }}>{user.displayName}</div>
                                            </NavDropdown.Item>
                                            <NavDropdown.Item><Nav.Link eventKey={10} className={"m-0 p-0"} style={{fontSize:'14px'}} onClick={navigateToMyProfile}>My Profile</Nav.Link></NavDropdown.Item>
                                            <NavDropdown.Item>
                                                <div className="logoutNavBar">
                                                    <Nav.Link eventKey={10} className={"m-0 p-0"} style={{fontSize:'14px'}} onClick={handleLogout}>Logout</Nav.Link>
                                                </div>
                                            </NavDropdown.Item>
                                        </NavDropdown>
